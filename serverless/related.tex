...
One load balancing design sought to lower latency by mixing in low- and high-end servers for executing functions \cite{roy2022icebreaker}, cheap and plentify memory to host many sandboxes with a few fast machines to speed up popular functions.
