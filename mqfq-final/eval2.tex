...
\begin{figure}
  ...
  {\includegraphics[width=0.5\textwidth]{./mqfq-final/graphs/q_compare/25.7095/20/no_naive_e2e_sec.pdf}}
 \hfill  
\subfloat[The average and variance of \textbf{per-function latency} is much lower with \QName.  \label{fig:queue-fairness}]
{\includegraphics[width=0.5\textwidth]{./mqfq-final/graphs/q_compare/25.7095/20/paper_fairness.pdf}}
\hfill 
\subfloat[\textbf{Device utilization} for the medium-load trace. \label{fig:util} ]
{\includegraphics[width=0.5\textwidth]{./mqfq-final/graphs/q_compare/25.7095/20/all_util_no_zeroes.pdf}}
\label{fig:base-all}
