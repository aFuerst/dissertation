...
\begin{figure*}[ht] \subfloat[Latency]{\includegraphics[width=0.3\textwidth]{../figs/compare/120-global-latencies-cntnorm.pdf} \label{fig:120-normalized-latencies}} \subfloat[Throughput]{\includegraphics[width=0.3\textwidth]{../figs/compare/120-invokes-ttl.pdf} \label{fig:120-invokes}}
